        ...
        <form action="processar_edicao_perfil.php" method="POST" class="profile-settings-form">
            <section class="profile-info-section">
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        <input type="text" id="given-name" name="given_name" value="<?php echo $nome_usuario; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        <input type="email" id="email-address" name="email_address" value="<?php echo $email_usuario; ?>">
                        <i class="fas fa-edit edit-icon"></i>
                    </div>
                </div>
            </section>
                ...
                <div class="favorite-films-selection">
                    <?php foreach ($filmes_favoritos_data as $index => $filme): ?>
                        <div class="film-selection-card">
                            <img src="https://image.tmdb.org/t/p/w185<?php echo $filme['poster']; ?>" alt="<?php echo $filme['titulo']; ?> Poster">
                ...
                <div class="avatar-selection-grid">
                    <?php foreach ($fotos as $index => $foto_url): ?>
                        <div class="avatar-option <?php echo ($foto_url == $foto_url_atual ? 'selected' : ''); ?>">
                            ...
                            <input type="radio" name="profile_avatar" value="<?php echo $foto_url; ?>" <?php echo ($foto_url == $foto_url_atual ? 'checked' : ''); ?>>                        </div>
                    <?php endforeach; ?>
                </div>
            </section>
